...
export type GetTodosQuery = { todos: Array<{ id: string, title: string, description: string | null, completed: boolean, createdAt: unknown, updatedAt: unknown }> };
...
export type GetTodoQuery = { todo: { id: string, title: string, description: string | null, completed: boolean, createdAt: unknown, updatedAt: unknown } | null };
...
export type CreateTodoMutation = { createTodo: { id: string, title: string, description: string | null, completed: boolean, createdAt: unknown, updatedAt: unknown } };
...
export type UpdateTodoMutation = { updateTodo: { id: string, title: string, description: string | null, completed: boolean, createdAt: unknown, updatedAt: unknown } | null };
...
// @ts-ignore
export function useGetTodoSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<GetTodoQuery, GetTodoQueryVariables>): Apollo.UseSuspenseQueryResult<GetTodoQuery, GetTodoQueryVariables>;
export function useGetTodoSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetTodoQuery, GetTodoQueryVariables>): Apollo.UseSuspenseQueryResult<GetTodoQuery | undefined, GetTodoQueryVariables>;
